...
- The visible hand is automatically sorted with trumps first, then plain suits
- Cards are rendered with German-suited Altenburg-inspired labels for Eichel, Gras, Herz, and Schellen
...
3. Play from the sorted visible hand shown for the current player
4. Follow on-screen prompts for bidding and card play
...
│   └── uiState.js          # Visible-player and bidding UI helpers
├── tests/
...
│   ├── german-altenburg-cards-sorted-hand-architecture.md # Architecture note
│   └── ux/
│       ├── README.md               # UX brief conventions
│       └── german-altenburg-cards-sorted-hand-ux-brief.md # UX design brief
└── .github/
